...
function QuestionSection({ mockInterviewQuestion,ActiveQuestionIndex }) {
    ...
    return mockInterviewQuestion&& (
        <div className="p-5 border rounded-lg my-10">
            ...
            <h2>{mockInterviewQuestion.questions[ActiveQuestionIndex]?.question.question}</h2>
            <h2 className='my-5 text-md md:text-lg'>{mockInterviewQuestion.questions[ActiveQuestionIndex]?.question}</h2>
